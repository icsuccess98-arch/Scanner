...
def update_game_historical_data(game: Game) -> bool:
    ...
    - If picking HOME favorite: Home avg margin should exceed 75% of spread
    - If picking AWAY underdog: Away avg margin supports 75% of the points OR team is profitable
    """
    try:
        ...
        if game.spread_is_qualified and game.spread_line is not None:
            ...
            if game.spread_direction == "HOME":
                spread_qualified = home_avg_margin >= abs(spread_line) * 0.75
            elif game.spread_direction == "AWAY":
                spread_qualified = away_avg_margin >= -abs(spread_line) * 0.75 or away_avg_margin > 0
            else:
