#!/bin/bash
# Tennis Daily Automation - 730's Locks Scanner Integration
# Runs tennis prediction engine and delivers A-grade picks

SCANNER_DIR="/home/icsuccess98/.openclaw/workspace/Scanner"
...
log "🎾 Tennis Daily Automation - Starting (Scanner Integration)"
...
python3 tennis_prediction_engine.py > "$WORKSPACE/logs/tennis-engine-output.log" 2>&1
...
log "🎾 Tennis Daily Automation - Complete (Scanner Integration)"