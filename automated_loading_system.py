...
ESPN_CBB_TEAM_IDS = {
    ...
    'West Georgia': 2698,
    'west_georgia': 2698,
    # Canonical key mappings (team_identity.py canonical_key → ESPN ID)
    'alabama_am': 2010,
    ...
    'san_francisco': 2539,
    'santa_clara': 2541,
    'siu_edwardsville': 2565,
    'south_carolina_state': 2569,
    'south_carolina_upstate': 2908,
    'south_florida': 58,
    'southeast_missouri_state': 2546,
