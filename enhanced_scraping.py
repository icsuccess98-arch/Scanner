...
class CoversScraper:
    ...
    CACHE_TTL = 600  # Cache for 10 minutes (was 60s — page loads were triggering fresh scrapes)
...
class ScoresAndOddsScraper:
    ...
    CACHE_TTL = 600  # Cache for 10 minutes (was 30s — every page load was scraping live)
