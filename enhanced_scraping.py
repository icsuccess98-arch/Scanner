...
CBB_TEAM_NAME_ALIASES = {
    ...
    # ============================================================
    # COVERS.COM ABBREVIATIONS (from matchups page & team logos)
    # ============================================================
    'KENN': 'Kennesaw St.',
    ...
    # ============================================================
    # TEAMRANKINGS.COM NAME FORMATS
    # Maps TeamRankings short names → KenPom canonical names
    # ============================================================
    ...
    'MSMU': "Mount St. Mary's",
    'N Carolina': 'North Carolina',
    'S Alabama': 'South Alabama',
    'So Alabama': 'South Alabama',
    'S Carolina St': 'SC State',
    ...
    'SE Mo State': 'SE Missouri St.',
    'Southeastern Mo': 'SE Missouri St.',
    'SEMO': 'SE Missouri St.',
    ...
    'Cal Northridge': 'Cal St. Northridge',
