...
if not CBB_TEAM_LOGOS:
    ...
    # Additional teams for complete D1 coverage
    ...
    'CS Bakersfield': 'https://a.espncdn.com/i/teamlogos/ncaa/500/2934.png',
    'CS Fullerton': 'https://a.espncdn.com/i/teamlogos/ncaa/500/2239.png',
    'CS Northridge': 'https://a.espncdn.com/i/teamlogos/ncaa/500/2463.png',
    ...
    'Nicholls State': 'https://a.espncdn.com/i/teamlogos/ncaa/500/2447.png',
    ...
    'Queens': 'https://a.espncdn.com/i/teamlogos/ncaa/500/3157.png',
    ...
    'Saint Josephs': 'https://a.espncdn.com/i/teamlogos/ncaa/500/2603.png',
    "Saint Peter's": 'https://a.espncdn.com/i/teamlogos/ncaa/500/2612.png',
    'Saint Peters': 'https://a.espncdn.com/i/teamlogos/ncaa/500/2612.png',
    ...
    'USC Upstate': 'https://a.espncdn.com/i/teamlogos/ncaa/500/2908.png',
    'South Carolina Upstate': 'https://a.espncdn.com/i/teamlogos/ncaa/500/2908.png',
    'SE Missouri State': 'https://a.espncdn.com/i/teamlogos/ncaa/500/2546.png',
    ...
    'Southern University': 'https://a.espncdn.com/i/teamlogos/ncaa/500/2582.png',
    'Southern Indiana': 'https://a.espncdn.com/i/teamlogos/ncaa/500/88.png',
    'USI': 'https://a.espncdn.com/i/teamlogos/ncaa/500/88.png',
    ...
    'Tennessee Martin': 'https://a.espncdn.com/i/teamlogos/ncaa/500/2630.png',
    ...
    'Texas A&M-Corpus Christi': 'https://a.espncdn.com/i/teamlogos/ncaa/500/357.png',
    'Texas A&M-Commerce': 'https://a.espncdn.com/i/teamlogos/ncaa/500/2868.png',
...
def get_covers_matchup_stats(league: str = 'NBA') -> Dict:
    ...
    # CBB Team abbreviation to full name mapping
    # Auto-generated from team_identity.py CBB_COVERS_DISPLAY (362 teams)
    # then supplemented with manual overrides for Covers.com-specific abbreviations
    try:
        from team_identity import CBB_COVERS_DISPLAY
        cbb_abbr_to_name = {}
        # Build canonical_key -> display name mapping
        _canonical_to_display = {
            'abilene_christian': 'Abilene Christian', 'air_force': 'Air Force', 'akron': 'Akron',
            'alabama': 'Alabama', 'alabama_am': 'Alabama A&M', 'alabama_state': 'Alabama State',
            'albany': 'Albany', 'alcorn_state': 'Alcorn State', 'american': 'American',
            'appalachian_state': 'Appalachian State', 'arizona': 'Arizona', 'arizona_state': 'Arizona State',
            'arkansas': 'Arkansas', 'arkansas_pine_bluff': 'Arkansas-Pine Bluff',
            'arkansas_state': 'Arkansas State', 'army': 'Army', 'auburn': 'Auburn',
            'ball_state': 'Ball State', 'baylor': 'Baylor', 'bellarmine': 'Bellarmine',
            'belmont': 'Belmont', 'bethune_cookman': 'Bethune-Cookman', 'binghamton': 'Binghamton',
            'boise_state': 'Boise State', 'boston_college': 'Boston College',
            'boston_university': 'Boston University', 'bowling_green': 'Bowling Green',
            'bradley': 'Bradley', 'brown': 'Brown', 'bryant': 'Bryant', 'bucknell': 'Bucknell',
            'buffalo': 'Buffalo', 'butler': 'Butler', 'byu': 'BYU',
            'cal_baptist': 'Cal Baptist', 'cal_poly': 'Cal Poly', 'california': 'California',
            'campbell': 'Campbell', 'canisius': 'Canisius', 'central_arkansas': 'Central Arkansas',
            'central_connecticut': 'Central Connecticut', 'central_michigan': 'Central Michigan',
            'charleston': 'Charleston', 'charleston_southern': 'Charleston Southern',
            'charlotte': 'Charlotte', 'chattanooga': 'Chattanooga', 'chicago_state': 'Chicago State',
            'cincinnati': 'Cincinnati', 'citadel': 'The Citadel', 'clemson': 'Clemson',
            'cleveland_state': 'Cleveland State', 'coastal_carolina': 'Coastal Carolina',
            'colgate': 'Colgate', 'colorado': 'Colorado', 'colorado_state': 'Colorado State',
            'columbia': 'Columbia', 'connecticut': 'UConn', 'coppin_state': 'Coppin State',
            'cornell': 'Cornell', 'creighton': 'Creighton',
            'cs_bakersfield': 'CS Bakersfield', 'cs_fullerton': 'CS Fullerton', 'cs_northridge': 'CS Northridge',
            'dartmouth': 'Dartmouth', 'davidson': 'Davidson', 'dayton': 'Dayton',
            'delaware': 'Delaware', 'delaware_state': 'Delaware State', 'denver': 'Denver',
            'depaul': 'DePaul', 'detroit_mercy': 'Detroit Mercy', 'drake': 'Drake',
            'drexel': 'Drexel', 'duke': 'Duke', 'duquesne': 'Duquesne',
            'east_carolina': 'East Carolina', 'east_tennessee_state': 'East Tennessee State',
            'eastern_illinois': 'Eastern Illinois', 'eastern_kentucky': 'Eastern Kentucky',
            'eastern_michigan': 'Eastern Michigan', 'eastern_washington': 'Eastern Washington',
            'elon': 'Elon', 'evansville': 'Evansville',
            'fairfield': 'Fairfield', 'fairleigh_dickinson': 'Fairleigh Dickinson',
            'fiu': 'FIU', 'florida': 'Florida', 'florida_am': 'Florida A&M',
            'florida_atlantic': 'Florida Atlantic', 'florida_gulf_coast': 'Florida Gulf Coast',
            'florida_state': 'Florida State', 'fordham': 'Fordham', 'fresno_state': 'Fresno State',
            'furman': 'Furman',
            'gardner_webb': 'Gardner-Webb', 'george_mason': 'George Mason',
            'george_washington': 'George Washington', 'georgetown': 'Georgetown',
            'georgia': 'Georgia', 'georgia_southern': 'Georgia Southern',
            'georgia_state': 'Georgia State', 'georgia_tech': 'Georgia Tech',
            'gonzaga': 'Gonzaga', 'grambling': 'Grambling', 'grand_canyon': 'Grand Canyon',
            'green_bay': 'Green Bay',
            'hampton': 'Hampton', 'harvard': 'Harvard', 'hawaii': 'Hawaii',
            'high_point': 'High Point', 'hofstra': 'Hofstra', 'holy_cross': 'Holy Cross',
            'houston': 'Houston', 'houston_christian': 'Houston Christian', 'howard': 'Howard',
            'idaho': 'Idaho', 'idaho_state': 'Idaho State', 'illinois': 'Illinois',
            'illinois_state': 'Illinois State', 'incarnate_word': 'Incarnate Word',
            'indiana': 'Indiana', 'indiana_state': 'Indiana State', 'iona': 'Iona',
            'iowa': 'Iowa', 'iowa_state': 'Iowa State', 'iu_indianapolis': 'IU Indianapolis',
            'jackson_state': 'Jackson State', 'jacksonville': 'Jacksonville',
            'jacksonville_state': 'Jacksonville State', 'james_madison': 'James Madison',
            'kansas': 'Kansas', 'kansas_state': 'Kansas State', 'kennesaw_state': 'Kennesaw State',
            'kent_state': 'Kent State', 'kentucky': 'Kentucky',
            'la_salle': 'La Salle', 'lafayette': 'Lafayette', 'lamar': 'Lamar',
            'le_moyne': 'Le Moyne', 'lehigh': 'Lehigh', 'liberty': 'Liberty',
            'lindenwood': 'Lindenwood', 'lipscomb': 'Lipscomb', 'little_rock': 'Little Rock',
            'long_beach_state': 'Long Beach State', 'long_island': 'LIU', 'longwood': 'Longwood',
            'louisiana': 'Louisiana', 'louisiana_monroe': 'Louisiana Monroe',
            'louisiana_tech': 'Louisiana Tech', 'louisville': 'Louisville',
            'loyola_chicago': 'Loyola Chicago', 'loyola_maryland': 'Loyola Maryland',
            'loyola_marymount': 'Loyola Marymount', 'lsu': 'LSU',
            'maine': 'Maine', 'manhattan': 'Manhattan', 'marist': 'Marist',
            'marquette': 'Marquette', 'marshall': 'Marshall', 'maryland': 'Maryland',
            'maryland_eastern_shore': 'Maryland-Eastern Shore', 'massachusetts': 'UMass',
            'mcneese': 'McNeese', 'memphis': 'Memphis', 'mercer': 'Mercer',
            'mercyhurst': 'Mercyhurst', 'merrimack': 'Merrimack',
            'miami_fl': 'Miami', 'miami_oh': 'Miami OH', 'michigan': 'Michigan',
            'michigan_state': 'Michigan State', 'middle_tennessee': 'Middle Tennessee',
            'milwaukee': 'Milwaukee', 'minnesota': 'Minnesota', 'mississippi': 'Ole Miss',
            'mississippi_state': 'Mississippi State',
            'mississippi_valley_state': 'Mississippi Valley State',
            'missouri': 'Missouri', 'missouri_state': 'Missouri State',
            'monmouth': 'Monmouth', 'montana': 'Montana', 'montana_state': 'Montana State',
            'morehead_state': 'Morehead State', 'morgan_state': 'Morgan State',
            'mount_st_marys': "Mount St. Mary's", 'murray_state': 'Murray State',
            'navy': 'Navy', 'nc_state': 'NC State', 'nebraska': 'Nebraska',
            'nevada': 'Nevada', 'new_hampshire': 'New Hampshire', 'new_mexico': 'New Mexico',
            'new_mexico_state': 'New Mexico State', 'new_orleans': 'New Orleans',
            'niagara': 'Niagara', 'nicholls': 'Nicholls', 'njit': 'NJIT',
            'norfolk_state': 'Norfolk State', 'north_alabama': 'North Alabama',
            'north_carolina': 'North Carolina', 'north_carolina_at': 'North Carolina A&T',
            'north_carolina_central': 'North Carolina Central',
            'north_dakota': 'North Dakota', 'north_dakota_state': 'North Dakota State',
            'north_florida': 'North Florida', 'north_texas': 'North Texas',
            'northeastern': 'Northeastern', 'northern_arizona': 'Northern Arizona',
            'northern_colorado': 'Northern Colorado', 'northern_illinois': 'Northern Illinois',
            'northern_iowa': 'Northern Iowa', 'northern_kentucky': 'Northern Kentucky',
            'northwestern': 'Northwestern', 'northwestern_state': 'Northwestern State',
            'notre_dame': 'Notre Dame',
            'oakland': 'Oakland', 'ohio': 'Ohio', 'ohio_state': 'Ohio State',
            'oklahoma': 'Oklahoma', 'oklahoma_state': 'Oklahoma State',
            'old_dominion': 'Old Dominion', 'omaha': 'Omaha', 'oral_roberts': 'Oral Roberts',
            'oregon': 'Oregon', 'oregon_state': 'Oregon State',
            'pacific': 'Pacific', 'penn': 'Penn', 'penn_state': 'Penn State',
            'pepperdine': 'Pepperdine', 'pittsburgh': 'Pittsburgh', 'portland': 'Portland',
            'portland_state': 'Portland State', 'prairie_view': 'Prairie View A&M',
            'presbyterian': 'Presbyterian', 'princeton': 'Princeton',
            'providence': 'Providence', 'purdue': 'Purdue', 'purdue_fort_wayne': 'Purdue Fort Wayne',
            'queens': 'Queens', 'quinnipiac': 'Quinnipiac',
            'radford': 'Radford', 'rhode_island': 'Rhode Island', 'rice': 'Rice',
            'richmond': 'Richmond', 'rider': 'Rider', 'robert_morris': 'Robert Morris',
            'rutgers': 'Rutgers',
            'sacramento_state': 'Sacramento State', 'sacred_heart': 'Sacred Heart',
            'saint_francis': "St. Francis (PA)", 'saint_josephs': "Saint Joseph's",
            'saint_louis': 'Saint Louis', 'saint_marys': "Saint Mary's",
            'saint_peters': "Saint Peter's", 'sam_houston': 'Sam Houston',
            'samford': 'Samford', 'san_diego': 'San Diego', 'san_diego_state': 'San Diego State',
            'san_francisco': 'San Francisco', 'san_jose_state': 'San Jose State',
            'santa_clara': 'Santa Clara', 'seattle': 'Seattle', 'seton_hall': 'Seton Hall',
            'siena': 'Siena', 'siu_edwardsville': 'SIU Edwardsville', 'smu': 'SMU',
            'south_alabama': 'South Alabama', 'south_carolina': 'South Carolina',
            'south_carolina_state': 'South Carolina State',
            'south_carolina_upstate': 'USC Upstate',
            'south_dakota': 'South Dakota', 'south_dakota_state': 'South Dakota State',
            'south_florida': 'South Florida',
            'southeast_missouri_state': 'SE Missouri State',
            'southeastern_louisiana': 'SE Louisiana',
            'southern': 'Southern', 'southern_illinois': 'Southern Illinois',
            'southern_indiana': 'Southern Indiana', 'southern_miss': 'Southern Miss',
            'southern_utah': 'Southern Utah', 'st_bonaventure': 'St. Bonaventure',
            'st_johns': "St. John's", 'st_thomas': 'St. Thomas',
            'stanford': 'Stanford', 'stephen_f_austin': 'Stephen F. Austin',
            'stetson': 'Stetson', 'stonehill': 'Stonehill', 'stony_brook': 'Stony Brook',
            'syracuse': 'Syracuse',
            'tarleton_state': 'Tarleton State', 'tcu': 'TCU', 'temple': 'Temple',
            'tennessee': 'Tennessee', 'tennessee_martin': 'UT Martin',
            'tennessee_state': 'Tennessee State', 'tennessee_tech': 'Tennessee Tech',
            'texas': 'Texas', 'texas_am': 'Texas A&M', 'texas_am_cc': 'Texas A&M-CC',
            'texas_am_commerce': 'Texas A&M-Commerce', 'texas_southern': 'Texas Southern',
            'texas_state': 'Texas State', 'texas_tech': 'Texas Tech',
            'toledo': 'Toledo', 'towson': 'Towson', 'troy': 'Troy',
            'tulane': 'Tulane', 'tulsa': 'Tulsa',
            'uab': 'UAB', 'uc_davis': 'UC Davis', 'uc_irvine': 'UC Irvine',
            'uc_riverside': 'UC Riverside', 'uc_san_diego': 'UC San Diego',
            'uc_santa_barbara': 'UC Santa Barbara', 'ucf': 'UCF', 'ucla': 'UCLA',
            'uic': 'UIC', 'umbc': 'UMBC', 'umkc': 'UMKC',
            'unc_asheville': 'UNC Asheville', 'unc_greensboro': 'UNC Greensboro',
            'unc_wilmington': 'UNC Wilmington', 'unlv': 'UNLV', 'usc': 'USC',
            'ut_arlington': 'UT Arlington', 'utah': 'Utah', 'utah_state': 'Utah State',
            'utah_tech': 'Utah Tech', 'utah_valley': 'Utah Valley',
            'utep': 'UTEP', 'utrgv': 'UTRGV', 'utsa': 'UTSA',
            'valparaiso': 'Valparaiso', 'vanderbilt': 'Vanderbilt', 'vcu': 'VCU',
            'vermont': 'Vermont', 'villanova': 'Villanova', 'virginia': 'Virginia',
            'virginia_tech': 'Virginia Tech', 'vmi': 'VMI',
            'wagner': 'Wagner', 'wake_forest': 'Wake Forest', 'washington': 'Washington',
            'washington_state': 'Washington State', 'weber_state': 'Weber State',
            'west_georgia': 'West Georgia', 'west_virginia': 'West Virginia',
            'western_carolina': 'Western Carolina', 'western_illinois': 'Western Illinois',
            'western_kentucky': 'Western Kentucky', 'western_michigan': 'Western Michigan',
            'wichita_state': 'Wichita State', 'william_mary': 'William & Mary',
            'winthrop': 'Winthrop', 'wisconsin': 'Wisconsin', 'wofford': 'Wofford',
            'wright_state': 'Wright State', 'wyoming': 'Wyoming',
            'xavier': 'Xavier', 'yale': 'Yale', 'youngstown_state': 'Youngstown State',
        }
        # Build abbrev -> display name from team_identity (362 teams)
        for canon_key, info in CBB_COVERS_DISPLAY.items():
            display = _canonical_to_display.get(canon_key, canon_key.replace('_', ' ').title())
            cbb_abbr_to_name[info['abbrev']] = display
    except ImportError:
        cbb_abbr_to_name = {}

    # Manual overrides for Covers.com-specific abbreviations not matching standard abbrevs
    cbb_abbr_to_name.update({
        'GASO': 'Georgia Southern', 'COLUM': 'Columbia', 'LOYCH': 'Loyola Chicago',
        'SCAR': 'South Carolina', 'BAMA': 'Alabama', 'CONN': 'UConn', 'TXAM': 'Texas A&M',
        'PURD': 'Purdue', 'IU': 'Indiana', 'OREG': 'Oregon', 'CINC': 'Cincinnati',
        'TULN': 'Tulane', 'SETON': 'Seton Hall', 'SJU': "St. John's",
        'VILL': 'Villanova', 'GMAS': 'George Mason', 'SBU': 'St. Bonaventure',
        'ZONA': 'Arizona', 'RIDE': 'Rider', 'AKRO': 'Akron', 'LITT': 'Little Rock',
        'UMAS': 'UMass', 'UMASS': 'UMass', 'MASS': 'UMass',
        'W MI': 'Western Michigan', 'W MICH': 'Western Michigan',
        'E MI': 'Eastern Michigan', 'E MICH': 'Eastern Michigan',
        'C MI': 'Central Michigan', 'C MICH': 'Central Michigan',
        'S IL': 'Southern Illinois', 'S ILL': 'Southern Illinois',
        'N IL': 'Northern Illinois', 'N ILL': 'Northern Illinois',
        'W IL': 'Western Illinois', 'E IL': 'Eastern Illinois',
        'ILL ST': 'Illinois State', 'ST J': "St. John's", "ST JOHN'S": "St. John's",
        'UT M': 'UT Martin', 'UTMT': 'UT Martin', 'VANDY': 'Vanderbilt',
        'ILLI': 'Illinois', 'ILLIN': 'Illinois', 'NEBR': 'Nebraska',
        'SPU': "Saint Peter's", 'STPET': "Saint Peter's",
    })
...
KENPOM_TEAM_SLUGS = {
    ...
    # Missing teams commonly appearing in games
    'Central Arkansas': 'Central.Arkansas', 'UCA': 'Central.Arkansas', 'C Arkansas': 'Central.Arkansas',
    'Cent Arkansas': 'Central.Arkansas',
    'Sam Houston': 'Sam.Houston.St.', 'SHSU': 'Sam.Houston.St.', 'Sam Houston State': 'Sam.Houston.St.',
    'Lamar': 'Lamar', 'Incarnate Word': 'Incarnate.Word', 'UIW': 'Incarnate.Word',
    'Abilene Christian': 'Abilene.Christian', 'ACU': 'Abilene.Christian',
    'Tarleton': 'Tarleton.St.', 'Tarleton State': 'Tarleton.St.',
    'Grand Canyon': 'Grand.Canyon', 'GCU': 'Grand.Canyon',
    'Cal Baptist': 'Cal.Baptist', 'CBU': 'Cal.Baptist',
    'Utah Valley': 'Utah.Valley', 'UVU': 'Utah.Valley',
    'Seattle': 'Seattle', 'Seattle U': 'Seattle',
    'Bellarmine': 'Bellarmine', 'Le Moyne': 'Le.Moyne',
    'Mercyhurst': 'Mercyhurst', 'Lindenwood': 'Lindenwood',
    'Southern Indiana': 'Southern.Indiana', 'USI': 'Southern.Indiana',
    'Queens': 'Queens', 'West Georgia': 'West.Georgia',
    'North Alabama': 'North.Alabama', 'UNA': 'North.Alabama',
    'Liberty': 'Liberty', 'Lipscomb': 'Lipscomb',
    'Jacksonville': 'Jacksonville', 'Stetson': 'Stetson',
    'Belmont': 'Belmont', 'Eastern Kentucky': 'Eastern.Kentucky',
    'Northern Kentucky': 'Northern.Kentucky', 'NKU': 'Northern.Kentucky',
    'Oakland': 'Oakland', 'Detroit Mercy': 'Detroit.Mercy',
    'Robert Morris': 'Robert.Morris', 'Purdue Fort Wayne': 'Purdue.Fort.Wayne',
    'Milwaukee': 'Milwaukee', 'Green Bay': 'Green.Bay',
    'FIU': 'FIU', 'Florida International': 'FIU',
    'South Florida': 'South.Florida', 'Temple': 'Temple',
    'Tulsa': 'Tulsa', 'Charlotte': 'Charlotte', 'Rice': 'Rice',
    'Marshall': 'Marshall', 'Louisiana': 'Louisiana', 'Louisiana Tech': 'Louisiana.Tech',
    'Louisiana Monroe': 'Louisiana.Monroe', 'Troy': 'Troy', 'South Alabama': 'South.Alabama',
    'Texas State': 'Texas.St.', 'Texas Southern': 'Texas.Southern',
    'Prairie View': 'Prairie.View.A&M', 'Prairie View A&M': 'Prairie.View.A&M', 'PVAM': 'Prairie.View.A&M',
    'Alabama A&M': 'Alabama.A&M', 'AAMU': 'Alabama.A&M',
    'Florida A&M': 'Florida.A&M', 'FAMU': 'Florida.A&M',
    'Bethune-Cookman': 'Bethune.Cookman', 'BCU': 'Bethune.Cookman',
    'North Carolina A&T': 'North.Carolina.A&T', 'NC A&T': 'North.Carolina.A&T', 'NCAT': 'North.Carolina.A&T',
    'North Carolina Central': 'North.Carolina.Central', 'NCCU': 'North.Carolina.Central',
    'Morgan State': 'Morgan.St.', 'Coppin State': 'Coppin.St.',
    'Howard': 'Howard', 'Delaware State': 'Delaware.St.',
    'Maryland-Eastern Shore': 'Maryland.Eastern.Shore', 'UMES': 'Maryland.Eastern.Shore',
    'Norfolk State': 'Norfolk.St.', 'Hampton': 'Hampton',
    'South Carolina State': 'South.Carolina.St.', 'SC State': 'South.Carolina.St.',
    'Mississippi Valley State': 'Mississippi.Valley.St.', 'MVSU': 'Mississippi.Valley.St.',
    'Arkansas-Pine Bluff': 'Arkansas.Pine.Bluff', 'UAPB': 'Arkansas.Pine.Bluff',
    'Jackson State': 'Jackson.St.', 'Alcorn State': 'Alcorn.St.',
    'Grambling': 'Grambling.St.', 'Grambling State': 'Grambling.St.',
    'Southern': 'Southern', 'Southern University': 'Southern',
    'Texas A&M-CC': 'Texas.A&M.Corpus.Christi', 'TAMUCC': 'Texas.A&M.Corpus.Christi',
    'Texas A&M-Commerce': 'Texas.A&M.Commerce', 'TAMUC': 'Texas.A&M.Commerce',
    'UTRGV': 'UT.Rio.Grande.Valley', 'UT Rio Grande Valley': 'UT.Rio.Grande.Valley',
    'Idaho': 'Idaho', 'Idaho State': 'Idaho.St.',
    'Montana State': 'Montana.St.', 'Weber State': 'Weber.St.',
    'Northern Arizona': 'Northern.Arizona', 'NAU': 'Northern.Arizona',
    'Northern Colorado': 'Northern.Colorado',
    'Portland State': 'Portland.St.', 'Portland': 'Portland',
    'Sacramento State': 'Sacramento.St.',
    'SIU Edwardsville': 'SIU.Edwardsville', 'SIUE': 'SIU.Edwardsville',
    'SE Missouri State': 'Southeast.Missouri.St.', 'SEMO': 'Southeast.Missouri.St.',
    'SE Louisiana': 'Southeastern.Louisiana',
    'Northwestern State': 'Northwestern.St.',
    'Nicholls': 'Nicholls.St.', 'Nicholls State': 'Nicholls.St.',
    'McNeese': 'McNeese.St.', 'McNeese State': 'McNeese.St.',
    'New Orleans': 'New.Orleans',
    'UC Davis': 'UC.Davis', 'UC Irvine': 'UC.Irvine', 'UC Riverside': 'UC.Riverside',
    'UC San Diego': 'UC.San.Diego', 'UC Santa Barbara': 'UC.Santa.Barbara',
    'UTEP': 'UTEP', 'UTSA': 'UTSA', 'UT Arlington': 'UT.Arlington',
    'Hawaii': 'Hawaii', "Hawai'i": 'Hawaii',
    'Cal Poly': 'Cal.Poly', 'Cal State Fullerton': 'Cal.St..Fullerton',
    'Cal State Northridge': 'Cal.St..Northridge', 'Cal State Bakersfield': 'Cal.St..Bakersfield',
    'Long Beach State': 'Long.Beach.St.', 'LBSU': 'Long.Beach.St.',
    'Pacific': 'Pacific', 'Pepperdine': 'Pepperdine',
    'Loyola Marymount': 'Loyola.Marymount', 'LMU': 'Loyola.Marymount',
    'Loyola Maryland': 'Loyola.MD', 'Loyola (MD)': 'Loyola.MD',
    'High Point': 'High.Point', 'Campbell': 'Campbell',
    'Longwood': 'Longwood', 'Winthrop': 'Winthrop', 'Radford': 'Radford',
    'Gardner-Webb': 'Gardner.Webb', 'Presbyterian': 'Presbyterian',
    'Charleston Southern': 'Charleston.Southern', 'Charleston': 'Charleston',
    'VMI': 'VMI', 'Samford': 'Samford', 'Furman': 'Furman',
    'Chattanooga': 'Chattanooga', 'Wofford': 'Wofford',
    'Monmouth': 'Monmouth', 'Quinnipiac': 'Quinnipiac', 'Rider': 'Rider',
    'Iona': 'Iona', 'Marist': 'Marist', 'Manhattan': 'Manhattan', 'Niagara': 'Niagara',
    'Canisius': 'Canisius', 'Siena': 'Siena', 'Fairfield': 'Fairfield',
    'Saint Josephs': 'St..Josephs', "Saint Joseph's": 'St..Josephs',
    'Hofstra': 'Hofstra', 'Delaware': 'Delaware', 'Elon': 'Elon',
    'William & Mary': 'William.&.Mary', 'Towson': 'Towson',
    'Drexel': 'Drexel', 'Northeastern': 'Northeastern',
    'Boston University': 'Boston.U.',
    'Bucknell': 'Bucknell', 'Lehigh': 'Lehigh', 'Colgate': 'Colgate',
    'Lafayette': 'Lafayette', 'Holy Cross': 'Holy.Cross',
    'La Salle': 'La.Salle', 'Fordham': 'Fordham',
    'George Washington': 'George.Washington', 'Duquesne': 'Duquesne',
    'Ball State': 'Ball.St.', 'Toledo': 'Toledo', 'Bowling Green': 'Bowling.Green',
    'Ohio': 'Ohio', 'Buffalo': 'Buffalo', 'Utah Tech': 'Utah.Tech',
    'Stony Brook': 'Stony.Brook', 'UMBC': 'UMBC', 'Vermont': 'Vermont',
    'Maine': 'Maine', 'New Hampshire': 'New.Hampshire',
    'Binghamton': 'Binghamton', 'Albany': 'Albany', 'UMass Lowell': 'UMass.Lowell',
    'UIC': 'Illinois.Chicago', 'Illinois Chicago': 'Illinois.Chicago',
    'Valparaiso': 'Valparaiso', 'Denver': 'Denver', 'Omaha': 'Omaha',
    'South Dakota': 'South.Dakota', 'South Dakota State': 'South.Dakota.St.',
    'North Dakota': 'North.Dakota', 'North Dakota State': 'North.Dakota.St.',
    'Oral Roberts': 'Oral.Roberts',
    'USC Upstate': 'South.Carolina.Upstate', 'South Carolina Upstate': 'South.Carolina.Upstate',
    'IU Indianapolis': 'IUPUI', 'IUPUI': 'IUPUI',
    'San Diego': 'San.Diego', 'San Francisco': 'San.Francisco',
    'LIU': 'LIU', 'Long Island': 'LIU',
    'USC Upstate': 'South.Carolina.Upstate',
    'Florida Gulf Coast': 'Florida.Gulf.Coast', 'FGCU': 'Florida.Gulf.Coast',
    'Coastal Carolina': 'Coastal.Carolina',
    'Old Dominion': 'Old.Dominion', 'James Madison': 'James.Madison',
    'Southern Miss': 'Southern.Miss',
    'North Texas': 'North.Texas', 'North Florida': 'North.Florida',
    'East Carolina': 'East.Carolina',
    'Appalachian State': 'Appalachian.St.', 'App State': 'Appalachian.St.',
    'Georgia Southern': 'Georgia.Southern',
    'South Dakota St': 'South.Dakota.St.', 'South Dakota St.': 'South.Dakota.St.',
    'Wyoming': 'Wyoming', 'Colorado State': 'Colorado.St.', 'Utah State': 'Utah.St.',
    'Fresno State': 'Fresno.St.', 'New Mexico': 'New.Mexico',
    'New Mexico State': 'New.Mexico.St.', 'NMSU': 'New.Mexico.St.',
    'Air Force': 'Air.Force', 'San Jose State': 'San.Jose.St.',
}


def get_kenpom_slug(team_name: str) -> str:
    """Convert team name to KenPom URL slug."""
    # Try exact match first in legacy dict
    if team_name in KENPOM_TEAM_SLUGS:
        return KENPOM_TEAM_SLUGS[team_name]

    # Try case-insensitive match in legacy dict
    for key, slug in KENPOM_TEAM_SLUGS.items():
        if key.lower() == team_name.lower():
            return slug

    # Fall back to team_identity.py's comprehensive KENPOM_SLUGS (207 entries)
    try:
        from team_identity import normalize_team_name, get_kenpom_slug as identity_kenpom_slug
        canonical = normalize_team_name(team_name, 'CBB')
        if canonical:
            return identity_kenpom_slug(canonical)
    except ImportError:
        pass
